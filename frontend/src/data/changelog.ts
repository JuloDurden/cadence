...
export const CHANGELOG: ChangelogVersion[] = [
  {version:'v0.97.7',date:'7 Août 2026',dateISO:'2026-08-07',title:'Réglages : options de réinitialisation (Product Backlog, Clients, reset total) ; correctifs Dashboard (positions de widgets) et Sidebar (état réduit)',current:true,changes:[
