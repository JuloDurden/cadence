...
export const CHANGELOG: ChangelogVersion[] = [
  {version:'v0.98.18',date:'20 Août 2026',dateISO:'2026-08-20',title:'Now/Next/Later : correction du bug de liaison calque / forme, Compagnon IA : garantie technique de confirmation avant application de plan, sauvegarde : contrôle de concurrence optimiste, Rétrospective : fiabilisation de la sauvegarde',current:true,changes:[
