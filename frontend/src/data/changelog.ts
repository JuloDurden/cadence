...
export const CHANGELOG: ChangelogVersion[] = [
  {version:'v0.98.20',date:'22 Août 2026',dateISO:'2026-08-22',title:'Compagnon IA : réintroduction d\'une confirmation avant application d\'un plan de sprints, via un bouton dédié',current:true,changes:[
    {tag:'feat', text:'Compagnon IA, planification de sprints conversationnelle : simuler un plan (critère, phrase libre, ou les deux) n\'écrit plus directement le Backlog pour un compte PO/Admin - le résultat affiche désormais un bouton "Appliquer ce plan" sous la réponse, seul moyen de l\'appliquer réellement (réaffectation des items, création des sprints nécessaires, matérialisation des items fictifs, écriture du thème/Sprint Goal/métriques). Tant qu\'il n\'est pas cliqué, rien n\'est écrit'},
    {tag:'feat', text:'Une demande de modification après une simulation (autres critères, ou simplement renommer le thème/Sprint Goal/métriques proposés) produit un nouveau résultat avec un nouveau bouton à jour, sans limite de nombre d\'allers-retours avant application - la proposition précédente devient automatiquement inactive dès qu\'une plus récente existe dans la conversation, pour ne jamais pouvoir appliquer par erreur une version périmée'},
    {tag:'test', text:'Tests logiques (`tests/run-tests.js`, 88 tests sur ce module) et E2E (`tests/chat.spec.js`) mis à jour : simulation en lecture seule, application via le bouton dédié, échec de l\'application (bouton réactivé), modification du thème seul sans changer la composition du plan, proposition périmée rendue inactive'},
  ]},
  {version:'v0.98.19',date:'21 Août 2026',dateISO:'2026-08-21',title:'Compagnon IA : planification de sprints appliquée directement, sans confirmation intermédiaire, thème adapté au critère de planification',current:false,changes:[
    {tag:'fix', text:'Compagnon IA, planification de sprints conversationnelle : la confirmation avant application d\'un plan simulé (v0.98.18) provoquait une boucle où le plan était redemandé en confirmation indéfiniment, sans jamais être écrit, malgré plusieurs renforcements techniques successifs de cette confirmation. L\'étape de confirmation est retirée temporairement : simuler un plan de sprints (critère, phrase libre, ou les deux) l\'écrit désormais directement pour un compte PO/Admin, thème/Sprint Goal/métriques de chaque sprint compris, en un seul appel - une étape de confirmation sera réintroduite une fois l\'application elle-même fiabilisée'},
    {tag:'improve', text:'Compagnon IA : le thème généré pour un sprint sans Epic dominant clair (par exemple un sprint majoritairement composé de bugs) tient désormais aussi compte du ou des critères de planification actifs (ex. "Dette technique") plutôt que de retomber sur un thème générique'},
    {tag:'test', text:'Tests logiques (`tests/run-tests.js`) et E2E (`tests/chat.spec.js`) mis à jour pour refléter le nouveau comportement : simulation d\'un plan par un compte PO/Admin appliquée directement, sans confirmation ni second outil à appeler'},
  ]},
  {version:'v0.98.18',date:'20 Août 2026',dateISO:'2026-08-20',title:'Now/Next/Later : correction du bug de liaison calque / forme, Compagnon IA : garantie technique de confirmation avant application de plan, sauvegarde : contrôle de concurrence optimiste, Rétrospective : fiabilisation de la sauvegarde',current:false,changes:[
    {tag:'fix', text:'Un calque verrouillé n\'empêchait jusqu\'ici rien du tout sur le canevas (`.locked` n\'était consulté que depuis le panneau de calques, pour renommer/supprimer/activer un calque) : il n\'empêche désormais plus seulement d\'agir depuis le panneau, mais aussi de sélectionner ou manipuler la forme, le texte ou le tracé qui lui est rattaché, que ce soit au clic, au rectangle de sélection ou au lasso'},
    {tag:'fix', text:'En cas de formes superposées, cliquer ne sélectionnait pas forcément celle visuellement au-dessus : le hit-test testait les calques du plus bas au plus haut au lieu de l\'inverse, contrairement à l\'ordre de rendu réel. Corrigé pour que le clic respecte désormais l\'ordre des calques, comme un vrai z-index'},
    {tag:'feat', text:'Sélectionner une forme, un texte ou un tracé met désormais en surbrillance son calque dans le panneau, même si ce n\'est pas le calque actif (cible du prochain dessin) - même principe que la surbrillance déjà existante pour un cadre Epic/Initiative sélectionné'},
    {tag:'fix', text:'Compagnon IA, planification de sprints conversationnelle : l\'attente d\'une confirmation explicite avant d\'appliquer un plan simulé, et la reprise des mêmes paramètres entre simulation et application, ne reposaient jusqu\'ici que sur des instructions de prompt - un appel à l\'application d\'un plan est désormais aussi vérifié techniquement côté serveur (simulation préalable requise, vrai message de l\'utilisateur envoyé depuis - y compris après une première application déjà effectuée), avant d\'être exécuté'},
    {tag:'test', text:'Nouveaux tests logiques (`tests/run-tests.js`) sur la vérification de confirmation avant application d\'un plan par le Compagnon IA : aucune simulation préalable, simulation et application dans le même tour, confirmation valide avec reprise des bons paramètres, plusieurs simulations successives, réapplication sans nouvel accord'},
    {tag:'fix', text:'La sauvegarde de l\'état (PUT /api/state) écrasait toujours l\'état existant avec la copie complète envoyée par le client, sans jamais vérifier qu\'elle avait été construite à partir de la dernière version connue : deux personnes modifiant l\'état en même temps pouvaient silencieusement s\'écraser l\'une l\'autre. La sauvegarde est désormais rejetée si quelqu\'un d\'autre a enregistré entre-temps ; l\'écran se resynchronise automatiquement sur la version la plus récente et un message prévient que le dernier changement n\'a pas été pris en compte, à refaire si besoin'},
    {tag:'perf', text:'La synchronisation en direct déjà en place (v0.98.16) évite que ce contrôle ne se déclenche à tort dès que 2 personnes travaillent en même temps sur l\'outil : la nouvelle vérification ne se déclenche que pour un vrai conflit, jamais pour une modification déjà visible en direct'},
    {tag:'test', text:'Nouveaux tests E2E (`tests/state-conflict.spec.js`) sur le rejet d\'une sauvegarde en conflit (resynchronisation, message, changement non réappliqué) et sur l\'absence de faux conflit après un message de synchronisation'},
    {tag:'fix', text:'Rétrospective : voter, ajouter ou supprimer un item ou une action, activer les votes anonymes reconstruisait toute la session à partir d\'un instantané potentiellement périmé avant de l\'enregistrer en un seul bloc - un changement reçu entre-temps d\'un autre compte actif au même moment pouvait donc être écrasé. Chaque interaction passe désormais par une action ciblée qui ne modifie que sa propre partie de la session, fusionnée contre l\'état réellement à jour au moment où elle s\'applique, plutôt que contre une copie figée'},
    {tag:'fix', text:'Rétrospective et Sprint Review : un compte pouvait recevoir un toast de conflit alors que rien n\'était réellement perdu, dès que 2 personnes étaient actives en même temps sur la même page - la sauvegarde automatique se redéclenchait aussi pour un changement reçu d\'un autre compte, pas seulement pour ses propres actions, entrant en course avec le contrôle de concurrence ci-dessus. La sauvegarde automatique ne se déclenche désormais plus que pour un changement réellement fait par ce compte'},
  ]},
  {version:'v0.98.17',date:'20 Août 2026',dateISO:'2026-08-20',title:'Nouveau design des cartes Initiative / Epic / Item (Kanban, Release Planning, Sprint Planning), Réglages associés',current:false,changes:[
    {tag:'feat', text:'Kanban, Release Planning (grille, panneau Non assigné, Swimlanes) et Sprint Planning (panneau Non attribué, cartes membre) : nouveau rendu des cartes Epic et des items orphelins (hors Epic) - dégradé de la couleur du client sur toute la carte (au lieu d\'une bordure colorée à gauche), effet de survol en parallaxe 3D (la carte s\'incline légèrement en suivant le curseur) avec un reflet holographique, un motif exclusif aux cartes "sommet" d\'un groupe (Epic hors Initiative, item hors Epic) qui n\'apparaît qu\'au survol, près du curseur. Les items rangés dans un Epic restent des cartes plates neutres, seul leur texte reflète l\'effet holo hérité du groupe survolé. Prototype dédié affiné avec Julien avant tout code (4 cas de figure Initiative/Epic/Item validés)'},
    {tag:'fix', text:'Sprint Planning : les groupes Epic (panneau Non attribué et cartes membre) n\'affichaient jusqu\'ici aucune couleur ni indication du client, contrairement aux mêmes groupes en Release Planning et Kanban ; ils portent désormais le même dégradé couleur client que les autres pages'},
    {tag:'feat', text:'Réglages > Apparence : 2 nouveaux interrupteurs, effet holographique et parallaxe 3D (indépendants), et un choix du motif de l\'effet holo avec un aperçu visuel réel et grand format de chaque motif (taille identique à ce qui est affiché sur les pages), lui-même réactif à l\'effet holographique au survol - 8 motifs (Losanges, Hexagones, Géométrique, Overlook, Scanlines, Double Bulle, Ondulation, Vagues), registre volontairement extensible. Préférences propres à chaque compte, comme le reste de la section Apparence (v0.98.16)'},
  ]},
  {version:'v0.98.16',date:'19 Août 2026',dateISO:'2026-08-19',title:'Synchronisation en direct étendue à toute l\'application, Réglages : préférences par compte, restrictions Dev, recadrage du logo',current:false,changes:[
    ...
    {tag:'feat', text:'Réglages > Apparence (thème, couleur principale par thème, densité d\'affichage, page de démarrage) deviennent des préférences propres à chaque compte connecté plutôt que partagées par tout le workspace. Nouveau champ `personalSettings` sur le compte, résolu en cascade (préférence du compte, sinon réglage workspace déjà existant, sinon défaut d\'origine) pour ne rien changer visuellement à un compte qui n\'a encore rien personnalisé. Logo d\'équipe et sidebar repliée par défaut restent des réglages de workspace, partagés par toute l\'équipe'},
    {tag:'fix', text:'Un compte Dev ne peut plus créer, clôturer ou rouvrir un sprint (Release Planning et Roadmap), décisions de planification réservées au PO/Scrum Master (+ Admin) ; Activer et Supprimer un sprint restent ouverts au Dev, comme le glisser-déposer d\'items entre sprints'},
    {tag:'ux', text:'Réglages : les sections Configuration des sprints, Colonnes Kanban et Tags sont désormais masquées pour un compte Dev, plutôt qu\'affichées sans qu\'il puisse y toucher'},
    {tag:'fix', text:'Les champs non modifiables selon le rôle du compte connecté apparaissent désormais visiblement désactivés (fond grisé, curseur interdit) plutôt que de sembler éditables sans l\'être'},
    {tag:'feat', text:'Logo d\'équipe (Réglages > Apparence) : l\'image chargée peut désormais être recadrée (déplacement + zoom), comme les photos de profil de l\'équipe. Composant de recadrage extrait en composant partagé, réutilisé pour la 1re fois hors de la page Équipe'},
    {tag:'fix', text:'Le fond de l\'icône du logo (Sidebar) utilisait la couleur principale du thème même quand un vrai logo d\'équipe était chargé ; il reprend désormais la couleur de fond de la Sidebar'},
    {tag:'test', text:'Nouveaux tests E2E sur l\'ouverture de la connexion temps réel (sur plusieurs pages) et sa tolérance à l\'échec, sur l\'isolation des préférences personnelles par compte, le masquage des sections de Réglages et la restriction du cycle de vie des sprints pour un Dev'},
    {tag:'fix', text:'Suite E2E rejouée après ce chantier : 12 échecs constatés et corrigés, tous sans lien avec le contenu testé par ces tests eux-mêmes. 4 dus au mode présentation public (`/present/:token`) : le Header partagé appelle désormais aussi `usePersonalSettings()` sans condition, et cette route n\'avait pas encore le Provider correspondant (même bug déjà rencontré avec le Compagnon IA, v0.98.6) ; corrigé en l\'ajoutant, le fetch réseau restant désactivé pour ce visiteur sans compte. 8 autres dus à des comptes de test sans rôle explicite déclenché par la nouvelle restriction du bouton "+ Sprint" (Planning, Roadmap, raccourcis Ctrl+Z/Ctrl+Y) : un rôle PO explicite leur a été donné, ces tests ne portant pas sur la restriction elle-même'},
  ]},
  ...
  {version:'v0.98.14',date:'17 Août 2026',dateISO:'2026-08-17',title:'Mode sombre, Sidebar, Réglages Apparence et Release Planning : corrections et améliorations diverses',current:false,changes:[
    ...
    {tag:'perf', text:'Réglages d\'apparence (thème, couleur, logo, densité...) : un seul envoi réseau 400ms après le dernier changement plutôt qu\'un envoi à chaque étape d\'un geste continu (curseur de densité, sélecteur de couleur natif), sans rien changer à l\'application visuelle immédiate ; la sauvegarde en attente est garantie envoyée si vous quittez la page ou rechargez juste après un changement'},
    {tag:'feat', text:'Écran de connexion : le thème sombre et la couleur principale personnalisée choisis en Réglages sont désormais repris dès cet écran, avant authentification (jusqu\'ici toujours bleu/indigo par défaut)'},
    {tag:'fix', text:'Release Planning : un Epic assigné directement à un sprint restait affiché comme un conteneur vide dans ce sprint même après le déplacement de toutes ses US ailleurs (autre sprint, terminées, annulées...), alors qu\'aucune de ses US n\'y était plus prévue. L\'Epic se décroche désormais automatiquement du sprint dès que sa dernière US en sort (glisser-déposer en Release Planning, retrait manuel du sprint en Kanban, décision Reporter/Annuler en Sprint Review, suppression du sprint) ; il redevient "Non assigné" et ne réapparaît dans un sprint que si une US y est explicitement replacée, ou si tout le groupe Epic est re-glissé. Un Epic sans aucune US reste affiché normalement là où il est assigné (placeholder volontaire, comportement inchangé depuis le 2026-07-29)'},
    {tag:'test', text:'Nouveaux tests E2E sur le décrochage automatique d\'un Epic (drag individuel d\'une dernière US, retrait Kanban, report/annulation en Sprint Review, suppression de sprint) et sur le maintien de l\'affichage d\'un Epic placeholder sans US'},
  ]},
  {version:'v0.98.13',date:'17 Août 2026',dateISO:'2026-08-17',title:'Correctifs Sprint Review : débordement des selects "Non terminé", vérification des Initiatives',current:false,changes:[
  ...
  {version:'v0.98.11',date:'17 Août 2026',dateISO:'2026-08-17',title:'Phase 6bis (roadmap v1) - refonte de l\'écran de connexion',current:false,changes:[
    ...
    {tag:'feat', text:'Favicon de l\'onglet du navigateur remplacé par le logo Cadence, dans la couleur principale réellement utilisée (thème clair/sombre/système, personnalisée ou non) : suit désormais tout changement de ce réglage en direct, comme le reste de l\'apparence'},
    {tag:'test', text:'Nouveaux tests E2E sur le repli du logo (avec et sans logo d\'équipe) et sur le maintien du fonctionnement des formulaires avec le nouvel habillage'},
  ]},
  {version:'v0.98.10',date:'16 Août 2026',dateISO:'2026-08-16',title:'Phase 6bis (roadmap v1) - Réglages, sous-chantier 4/4 : correctif sidebar repliée par défaut',current:false,changes:[
    {tag:'fix', text:'Le réglage "Sidebar repliée par défaut" (Apparence) ne se répercutait pas sur la Sidebar affichée après un changement, malgré le correctif de la v0.98.9. Cause réelle : la Sidebar écrivait une préférence dans le navigateur dès son tout premier affichage, avant même un clic sur le bouton replier/déplier, ce qui la faisait passer à tort pour une préférence personnelle déjà explicite et bloquait tout reflet ultérieur du réglage de Workspace. Cette écriture n\'a désormais lieu qu\'au clic réel sur le bouton'},
    {tag:'test', text:'Suite E2E complète rejouée (719 tests) : 21 échecs supplémentaires constatés et corrigés, tous dus à des fichiers de tests non mis à jour depuis le passage des Réglages en onglets (v0.98.7) - ces sections ne sont désormais montées dans la page qu\'une fois leur onglet ouvert'},
  ]},
  {version:'v0.98.9',date:'15 Août 2026',dateISO:'2026-08-15',title:'Phase 6bis (roadmap v1) - Réglages, sous-chantier 4/4 : correctifs constatés à l\'usage réel de la section Apparence',current:false,changes:[
    {tag:'fix', text:'Le thème "Système" ne s\'appliquait qu\'après avoir cliqué sur "Enregistrer", contrairement à Clair/Sombre qui s\'appliquaient déjà immédiatement au clic sur leur carte. Les 3 cartes de thème appliquent désormais toutes le changement sur-le-champ, Système résolu tout de suite via le réglage clair/sombre de l\'appareil'},
    {tag:'fix', text:'Couleur principale : les 2 réglages (clair et sombre) et leurs 2 aperçus étaient affichés en permanence côte à côte, avec une bascule manuelle indépendante du thème réellement choisi. Un seul réglage est désormais visible, celui du thème actuellement affiché (résolu si "Système"), sans bascule séparée'},
    {tag:'fix', text:'Logo d\'équipe, densité d\'affichage, page de démarrage et sidebar repliée par défaut ne s\'appliquaient qu\'après un clic sur "Enregistrer", comme le reste de la page (Sprint, Kanban, Tags), ce qui donnait l\'impression qu\'ils ne fonctionnaient pas du tout puisque rien d\'autre dans la section Apparence n\'exigeait cette étape. Toute la section Apparence s\'applique et se persiste désormais immédiatement, à chaque changement'},
    {tag:'fix', text:'La Sidebar affichée pendant la session de test ne reflétait un changement du réglage "Sidebar repliée par défaut" qu\'au tout premier chargement de l\'application, jamais en cours de session. Elle reflète désormais ce réglage en direct, tant qu\'aucune préférence personnelle explicite n\'a déjà été enregistrée dans le navigateur (celle-ci reste prioritaire une fois définie, comportement inchangé)'},
    {tag:'test', text:'Tests E2E réécrits en conséquence (application immédiate sans "Enregistrer", un seul réglage de couleur visible, repli en direct de la Sidebar)'},
  ]},
  {version:'v0.98.8',date:'13 Août 2026',dateISO:'2026-08-13',title:'Phase 6bis (roadmap v1) - Réglages, sous-chantier 4/4 : thème système, couleur principale par thème, logo d\'équipe, densité d\'affichage',current:false,changes:[
    {tag:'feat', text:'Nouvelle option de thème "Système" en plus de Clair/Sombre, qui suit le réglage clair/sombre de l\'appareil et bascule automatiquement si l\'appareil change de réglage pendant que l\'onglet reste ouvert. Sélecteur de thème en 3 cartes visuelles (aperçu miniature de chaque thème), la carte Système recomposant la vraie moitié gauche de la carte Clair et la vraie moitié droite de la carte Sombre'},
    {tag:'feat', text:'Couleur principale personnalisable, distincte par thème clair/sombre (une seule couleur ne garantit pas un bon contraste dans les deux) : palette prédéfinie ou couleur libre, avec un aperçu concret d\'une fenêtre de l\'application (onglets, boutons, liste) dans la couleur et le thème choisis'},
    {tag:'feat', text:'Logo d\'équipe (upload d\'image), affiché à la place des initiales par défaut dans la Sidebar'},
    {tag:'feat', text:'Densité d\'affichage réglable sur un curseur à 5 crans (Très compact à Très spacieux), avec aperçu en direct. Couvre pour l\'instant le Backlog (tableau) et le Kanban (cartes), pas encore branché sur les autres écrans'},
    {tag:'feat', text:'Page de démarrage après connexion configurable (Dashboard, Product Backlog, Sprint Planning ou Kanban), et sidebar repliée par défaut au tout premier chargement (une préférence explicite de l\'utilisateur, une fois enregistrée, prend toujours le dessus)'},
    {tag:'chore', text:'Écran de connexion volontairement laissé hors périmètre de ce sous-chantier (décision Julien), une modernisation de cet écran est envisagée séparément'},
  ]},
  {version:'v0.98.7',date:'13 Août 2026',dateISO:'2026-08-13',title:'Phase 6bis (roadmap v1) - Réglages, sous-chantier 1/4 : réorganisation en onglets',current:false,changes:[
    {tag:'refactor', text:'Page Réglages réorganisée en 6 onglets (Général, Équipe, Intégrations, Sécurité, Import/Export, Avancé) plutôt qu\'un long défilement vertical, à mesure que les sections s\'y sont accumulées (intégrations GitHub/Slack/Jira, Compagnon IA, jetons API, export/import Excel, réinitialisation). Un onglet dont tout le contenu est réservé à un rôle ne s\'affiche pas du tout, plutôt que d\'afficher un onglet vide'},
    {tag:'chore', text:'Répartition : Général (sprints, apparence, colonnes Kanban, tags), Équipe (gestion des comptes), Intégrations (GitHub/Slack/Jira/Compagnon IA), Sécurité (jetons API personnels), Import/Export (JSON et Excel), Avancé (mode présentation, réinitialisation)'},
  ]},
  {version:'v0.98.6',date:'12 Août 2026',dateISO:'2026-08-12',title:'Phase 6 (roadmap v1) - Compagnon IA : correctifs constatés à l\'usage réel après la mise en service de la planification conversationnelle',current:false,changes:[
    {tag:'fix', text:'Panneau de proposition d\'Auto-planning : le score SP affiché sur un Epic scindé sur plusieurs sprints (possible sans le critère "Cohésion Epic/Initiative" actif, un Epic pouvant alors être coupé par le seul jeu de la capacité) restait le score total de l\'Epic sur chaque sprint, comme si rien n\'en manquait. Format "X/Y SP" désormais utilisé, comme sur l\'Initiative depuis la v0.98.4 : part de l\'Epic réellement présente dans ce sprint, sur son score total'},
    {tag:'fix', text:'La conversation du Compagnon IA était persistée dans le navigateur sous une clé fixe, partagée par tous les comptes connectés sur le même poste : changer de compte (Admin ↔ Dev) affichait la conversation du compte précédent, y compris un refus d\'application lié à un rôle qui n\'était plus le bon, ce qui pouvait laisser croire à tort à un blocage persistant après le changement de compte. Conversation désormais scopée par compte connecté, avec rechargement automatique au changement de compte'},
    {tag:'feat', text:'La réponse d\'une simulation ou d\'une application de plan par le Compagnon IA regroupe désormais les items par Epic puis Initiative, comme le fait déjà le panneau de proposition d\'Auto-planning, plutôt qu\'une liste à plat par sprint'},
    {tag:'fix', text:'Une réponse 529 ("Overloaded") de l\'API Anthropic - une surcharge temporaire côté serveur, sans lien avec Cadence - affichait le JSON brut de l\'erreur dans le chat. Message clair ajouté, même traitement que les erreurs 401/429/404 déjà gérées'},
    {tag:'test', text:'Vérifié en conditions réelles par Julien : score SP d\'un Epic scindé sur plusieurs sprints, isolement de la conversation entre 2 comptes (Admin/Dev) puis application d\'un plan simulé après reconnexion en Admin, regroupement Epic/Initiative dans une réponse de simulation, et gestion d\'une surcharge 529 rencontrée en conditions réelles pendant ce test'},
  ]},
  {version:'v0.98.5',date:'12 Août 2026',dateISO:'2026-08-12',title:'Phase 6 (roadmap v1) - Compagnon IA, sous-chantier 4/4 étape 2/2 : planification de sprints conversationnelle',current:false,changes:[
    {tag:'feat', text:'Nouveaux outils du Compagnon IA simulate_sprint_plan et apply_sprint_plan : portage fidèle côté backend de l\'algorithme déterministe d\'Auto-planning (tri topologique des dépendances, capacité effective avec jours fériés français, 5 critères de tri, placement atomique Initiative → Epic → item), plutôt qu\'un raisonnement libre du modèle - décision Julien (AskUserQuestion), pour garantir un résultat identique à celui d\'Auto-planning. Auto-planning n\'est pas remplacé, reste l\'outil de planification à part entière, le Compagnon IA en reprend la logique de façon conversationnelle en complément'},
    {tag:'feat', text:'Le Compagnon IA applique désormais un plan directement après confirmation explicite de l\'utilisateur (réservé PO/Admin, mêmes droits que le bouton "Appliquer" d\'Auto-planning), plutôt que de se limiter à une suggestion à recopier à la main'},
    {tag:'feat', text:'Parité complète dès cette version avec Auto-planning : facteur de vélocité, overrides de capacité par sprint, items fictifs, overrides d\'item (statut/priorité/SP/dépendances)'},
    {tag:'feat', text:'Déclenchement par la commande /plan (raccourci vers simulate_sprint_plan avec le critère Priorité par défaut) ou en langage naturel libre'},
    {tag:'fix', text:'`Item.deps` stocke des identifiants, mais le tri topologique et le placement d\'Auto-planning (topoSort/placeOne/placeGroupAtomically) les comparaient à tort à des CLÉS - désactivait silencieusement tout ordonnancement par dépendance. Corrigé dans Auto-planning et dans le nouveau portage backend, pour rester cohérents l\'un avec l\'autre'},
    {tag:'feat', text:'Assouplissement du placement des dépendances (retour Julien) : une dépendance peut désormais être placée sur le même sprint que l\'item qui en dépend (cas réel de découpage vertical), l\'item dépendant n\'étant jamais traité avant sa dépendance même dans ce cas ; nouvelle alerte informative quand deux items interdépendants partagent un même sprint'},
    {tag:'fix', text:'La résolution d\'un sprint référencé par son numéro ("Sprint 3") échouait silencieusement dès que ce sprint portait un libellé personnalisé, seul le libellé exact étant reconnu jusqu\'ici - cause d\'une divergence observée entre une simulation du Compagnon IA et le résultat réel d\'Auto-planning (capacité forcée ignorée, Epic scindé de façon inattendue à l\'application). Résolution par libellé puis par numéro ajoutée, "Sprint N" désormais toujours visible dans le prompt système'},
    {tag:'chore', text:'L\'attente d\'une confirmation explicite avant application, et la réutilisation des mêmes paramètres entre une simulation et l\'application qui suit, reposent sur des instructions de prompt renforcées, pas sur un état serveur reliant les deux appels (le chat reste sans état côté serveur) - limite connue, documentée dans corrections futures.md'},
    {tag:'test', text:'Vérifié en conditions réelles par Julien : chaîne de 4 dépendances liées en cascade (replacées dans le bon ordre, y compris sur un même sprint), puis 8 scénarios couvrant planification basique, critère spécifique, client prioritaire, item fictif, capacité forcée, application réelle et droits d\'accès - 2 anomalies remontées en cours de test (résolution de sprint par numéro, Epic scindé à l\'application) corrigées dans la foulée'},
  ]},
  {version:'v0.98.4',date:'11 Août 2026',dateISO:'2026-08-11',title:'Phase 6 (roadmap v1) - Compagnon IA, sous-chantier 4 : Auto-planning tient compte des Epics/Initiatives',current:false,changes:[
    {tag:'feat', text:'Nouveau critère "Cohésion Epic/Initiative" dans les scénarios Auto-planning : les items d\'un même Epic ou d\'une même Initiative restent regroupés dans le même sprint autant que possible, activable/désactivable et réordonnable comme les autres critères. Auto-planning n\'est pas remplacé par cette évolution : il reste l\'outil de planification automatique, le Compagnon IA en reprendra la logique plus tard sous une forme conversationnelle, en complément'},
    {tag:'feat', text:'Placement atomique : un Epic (ou une Initiative dont la somme des composants tient dans la capacité d\'un sprint) est calé d\'un bloc dans le premier sprint qui a la place, complété par d\'autres Epics ou items sans Epic pour atteindre sa capacité, plutôt que rempli item par item sans se soucier des coupures'},
    {tag:'feat', text:'Une Initiative trop volumineuse pour tenir dans un seul sprint est dispatchée sur plusieurs sprints en gardant chacun de ses Epics entiers, jamais un Epic coupé en deux pour faire tenir l\'Initiative'},
    {tag:'feat', text:'Nouvelle alerte de scénario "Epic/Initiative scindé(e)" quand un Epic, ou une Initiative dont les Epics sont pourtant chacun intacts, se retrouve réparti sur plusieurs sprints'},
    {tag:'fix', text:'Panneau de proposition d\'un scénario : les items rattachés à une Initiative regroupant plusieurs Epics apparaissaient à plat, sans distinguer l\'Initiative de ses Epics. Affichage à 3 niveaux (Initiative > Epic > items), avec le score SP à côté du titre de chaque Epic et de chaque Initiative'},
    {tag:'fix', text:'Le score SP affiché sur une Initiative scindée sur plusieurs sprints correspondait à son score total, pas à ce qui était réellement présent dans le sprint affiché : corrigé pour n\'afficher que la part de l\'Initiative présente dans ce sprint précis'},
    {tag:'test', text:'Vérifié en conditions réelles : scénario avec seulement "Cohésion Epic/Initiative" actif, Epic de 20 SP réparti à cheval sur deux sprints alors qu\'un créneau exact restait disponible plus tôt, Initiative de 60 SP répartie sur ses 3 Epics entiers'},
  ]},
  {version:'v0.98.3',date:'10 Août 2026',dateISO:'2026-08-10',title:'Phase 6 (roadmap v1) - Compagnon IA, sous-chantier 3 : détection d\'anomalies via le chat',current:false,changes:[
  ...
  {version:'v0.97.9',date:'8 Août 2026',dateISO:'2026-08-08',title:'Phase 5 (roadmap v1) - MCP Claude (Cadence) : jetons API personnels, serveur MCP en lecture seule (Backlog, sprints, équipe, clients, hiérarchie)',current:false,changes:[
    ...
    {tag:'feat', text:'Nouveau serveur MCP (`mcp/`, package Node séparé) : expose à Claude, en langage naturel, le Backlog, les sprints, l\'équipe, les clients et les Epics/Initiatives de Cadence. Lecture seule pour ce premier chantier, l\'écriture est un chantier séparé à venir'},
    {tag:'feat', text:'8 outils MCP : `list_items` (filtres sprint/statut/client/Epic/assigné/tag/type/priorité), `get_item` (détail complet dont User Story et critères d\'acceptation), `list_sprints`, `get_current_sprint_summary` (répartition par statut, % complété), `list_team` (charge du sprint en cours), `list_clients`, `list_hierarchy` (Epics/Initiatives) et `search_backlog` (recherche libre)'},
    {tag:'chore', text:'Le serveur MCP ne porte aucune logique d\'authentification propre : il transmet simplement le jeton reçu à l\'API Cadence existante (`GET /api/state`), qui applique seule les règles de rôle. Configuration documentée dans `mcp/README.md` (Claude Desktop et Claude Code/Cowork)'},
  ]},
  {version:'v0.97.8',date:'7 Août 2026',dateISO:'2026-08-07',title:'Phase 5 (roadmap v1) - Réglages : export/import Excel du Product Backlog (items + Epics/Initiatives), mapping de colonnes à l\'import',current:false,changes:[
    {tag:'feat', text:'Nouvelle section Export/Import Excel en Réglages, distincte de l\'export/import JSON existant (celui-ci couvre tout le workspace, l\'Excel est scopé au Product Backlog). Le fichier exporté contient 2 feuilles : "Backlog" (items) et "Epics & Initiatives" (`state.hierarchyNodes`, distinct des items depuis la Phase 1), et sert lui-même de modèle pour le réimport'},
    {tag:'feat', text:'Export de la User Story complète (Rôle/Besoin/Bénéfice, pas seulement le titre) et des critères d\'acceptation, une ligne par critère au format "N. GIVEN ... WHEN ... THEN ...", reconnu à l\'import'},
    {tag:'feat', text:'Import via une fenêtre de correspondance des colonnes plutôt qu\'une correspondance silencieuse : chaque feuille du fichier se voit proposer une cible (Items du Backlog / Epics & Initiatives / Ignorer cette feuille, devinée depuis le nom de la feuille), et chaque colonne un champ Cadence (deviné par libellé, insensible aux accents et à la casse) ou "Ignorer cette colonne", ajustables avant validation'},
    {tag:'feat', text:'Ajout ou mise à jour par Clé (une ligne dont la Clé correspond à un élément existant le met à jour, sinon un nouvel élément est créé) ; une cellule laissée vide sur une mise à jour conserve la valeur existante plutôt que de l\'effacer'},
    {tag:'ux', text:'Toast récapitulatif après import : nombre d\'items et d\'Epics/Initiatives ajoutés et mis à jour, et de lignes ignorées faute de titre'},
    {tag:'chore', text:'`exceljs` utilisé plutôt que `xlsx` (SheetJS, présent dans l\'ancien prototype `cadence.html`) pour la lecture/écriture des classeurs : `xlsx` porte 2 failles de sécurité hautes sans correctif disponible sur le registre npm, dont une déclenchable en lisant un fichier non fiable, exactement l\'usage de l\'import'},
  ]},
  {version:'v0.97.7',date:'7 Août 2026',dateISO:'2026-08-07',title:'Réglages : options de réinitialisation (Product Backlog, Clients, reset total) ; correctifs Dashboard (positions de widgets) et Sidebar (état réduit)',current:false,changes:[
    {tag:'feat', text:'Nouvelle section "Réinitialisation" en Réglages, réservée au rôle Admin : bouton "Réinitialiser le Product Backlog" (supprime tous les items et Epics/Initiatives, remet les compteurs de clé à zéro, et nettoie tout ce qui y fait directement référence : historique, enregistrements des sessions/archives Sprint Review, post-its et cadres NNL liés à un item ou un Epic). Les sprints (dates, capacité, objectifs) et les clients ne sont pas affectés'},
    {tag:'feat', text:'Bouton "Réinitialiser les clients" (supprime tous les clients et leurs groupes), désactivé tant que le Product Backlog n\'est pas vide : items et Epics référencent un client, et la convention du projet est de détacher les références plutôt que d\'en laisser une morte (voir `utils/cascadeDelete.ts`), donc l\'ordre Backlog puis Clients est imposé plutôt qu\'un nettoyage automatique de `clientId`'},
    {tag:'ux', text:'Les deux boutons demandent confirmation (nombre d\'éléments concernés, action irréversible) via le système de dialogue de l\'outil avant toute suppression'},
    {tag:'feat', text:'Nouveau bouton "Réinitialiser toutes les données", section Réinitialisation élargie à Admin + PO : supprime en un seul geste les items, Epics/Initiatives, sprints, fiches équipe, clients, absences, Dailies, Rétrospectives, Sprint Review et le contenu Now/Next/Later. Les comptes utilisateurs (jamais stockés dans ces données) et les réglages personnalisés (tags, couleurs Kanban, thème, mode présentation) ne sont pas affectés'},
    {tag:'feat', text:'Confirmation renforcée pour ce bouton : saisie obligatoire du mot-clé "SUPPRIMER" dans une modal dédiée, bouton de validation désactivé tant que le texte ne correspond pas exactement, plutôt que la simple confirmation Oui/Non des deux autres boutons de la section'},
    {tag:'fix', text:'Dashboard : après un agrandissement de zone, les widgets posés dans les colonnes gagnées revenaient se coincer dans l\'ancien périmètre au refresh, alors que la zone restait visuellement large. `react-grid-layout` ne resynchronise jamais ses positions internes quand seul le nombre de colonnes change ; corrigé en forçant un remontage du composant à chaque changement de largeur mesurée, pour qu\'il reparte des vraies positions stockées avec le bon nombre de colonnes'},
    {tag:'fix', text:'Dashboard : un widget ajouté via la modal se plaçait toujours tout en bas de la zone, sans jamais chercher d\'emplacement libre ailleurs (ni dans un trou existant, ni dans l\'espace gagné par un agrandissement de zone). Recherche du premier emplacement libre ajoutée, à jour avec le nombre de colonnes réellement disponible dans la zone au moment de l\'ajout'},
    {tag:'fix', text:'Sidebar : l\'état réduit (collapse) repartait toujours déplié après un refresh, purement en mémoire jusqu\'ici. Persisté désormais localement (par utilisateur/appareil), comme le mode d\'affichage de la modale d\'item ou l\'orientation de la toolbar NNL'},
  ]},
  {version:'v0.97.6',date:'7 Août 2026',dateISO:'2026-08-07',title:'Phase 4 (roadmap v1) - Dashboard widgets : 7 nouveaux widgets (Progression par Epic, Forecast de livraison, Vue par client, Actions de rétro, Items bloqués par dépendance, Prêt pour planification, Charge actuelle par membre)',current:false,changes:[
